...
// ### Mill Recepty ###
// # Gelatina
mods.betterwithmods.Mill.addRecipe([<ore:barkWood>*2, <ore:dustSaltpeter>],[<nuclearcraft:gelatin>]);
mods.betterwithmods.Mill.addRecipe([<ore:dustWood>*2, <ore:dustSaltpeter>],[<nuclearcraft:gelatin>]);
