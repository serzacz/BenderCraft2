...
AssemblyTable.addRecipe("enderio_fluid_conduit", <enderio:item_liquid_conduit>*16, 20000, [<enderio:item_material:4>*6, <buildcraftsilicon:redstone_chipset>, <ore:blockGlass>*3, <ore:ingotIron>*3]);
...
AssemblyTable.addRecipe("enderio_ender_fluid_conduit", <enderio:item_liquid_conduit:2>*16, 20000, [<enderio:item_material:4>*6, <buildcraftsilicon:redstone_chipset:2>, <ore:blockGlassHardened>*3, <ore:ingotVibrantAlloy>]);

AssemblyTable.addRecipe("enderio_energy_conduit1", <enderio:item_power_conduit>*16, 20000, [<enderio:item_material:4>*6, <buildcraftsilicon:redstone_chipset:1>,<ore:itemInsulatedCopperCable>*4, <ore:ingotConductiveIron>*3]);
...
AssemblyTable.addRecipe("enderio_energy_conduit3", <enderio:item_power_conduit:2>*16, 20000, [<enderio:item_material:4>*6, <buildcraftsilicon:redstone_chipset:4>, <ore:itemInsulatedIronCable>*4, <ore:ingotVibrantAlloy>*3]);
...
AssemblyTable.addRecipe("enderio_me_dense_conduit", <enderio:item_me_conduit:1>*16, 20000, [<enderio:item_material:4>*6, <buildcraftsilicon:redstone_chipset:4>, <appliedenergistics2:part:76>*4, <ore:ingotDarkSteel>*3]);
...
AssemblyTable.addRecipe("enderio_energy_conduit2_v2", <enderio:item_power_conduit:1>*16, 20000, [<ore:itemInsulatedGoldCable>*4, <enderio:item_power_conduit>*4, <buildcraftsilicon:redstone_chipset:2>,<ore:ingotEnergeticAlloy>*3 ]);
